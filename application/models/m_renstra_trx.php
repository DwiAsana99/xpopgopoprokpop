...
class M_renstra_trx extends CI_Model
{
	...
	function get_renstra_belanja_per_tahun211($ta, $idK){
		//------- query by deesudi
			$query = $this->db->query("SELECT id ,tahun,
							...
							uraian_belanja,detil_uraian_belanja,volume,satuan,nominal_satuan,subtotal,tahun,id_kegiatan , kode_urusan , kode_bidang , kode_program, kode_kegiatan, REPLACE(UPPER(uraian_belanja), ' ','') as uraian_upper
							FROM t_renstra_belanja_kegiatan
	...
	function get_program_skpd_4_cetak($id_skpd){
		...
		if ($id_skpd_unit==$id_skpd) {
			$query_tambahan_lagi=" and id_skpd in (select id_skpd from m_skpd where kode_unit = '$id_skpd_unit')";
			$query_where_in = " t_renstra.id_skpd in (select id_skpd from m_skpd where kode_unit = '$id_skpd_unit')";
		}else{
			$query_tambahan_lagi=" and id_skpd = '$id_skpd'";
			$query_where_in = " t_renstra.id_skpd = '$id_skpd_unit'";
		}
		...
		if ($id_skpd_unit==$id_skpd) {
			$query_tambahan_unit=" and keg.id_skpd in (select id_skpd from m_skpd where kode_unit = '$id_skpd_unit') ";
		}else{
			$query_tambahan_unit=" and keg.id_skpd='$id_skpd' ";
		}
	...
	function get_belanja_kegiatan($id_kegiatan, $group=NULL, $id_pilihan=NULL, $tahun=NULL, $not_in=NULL){
		$th = "";
		$not = "";
		$group_by = "";
		$where_tambahan = "";
		...
		$query = "SELECT id ,tahun, id_renstra,
						...
						uraian_belanja, detil_uraian_belanja, volume, satuan, nominal_satuan, subtotal, id_kegiatan
						FROM t_renstra_belanja_kegiatan
						WHERE id_kegiatan = '$id_kegiatan' ".$th." ".$not." ".$where_tambahan."
						".$group_by."
