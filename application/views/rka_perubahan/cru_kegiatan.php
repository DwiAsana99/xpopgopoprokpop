...
// var status = true;
		...
		if (status) {
			$.ajax({
			    type: "POST",
			    url: '<?php echo site_url("rka_perubahan/belanja_kegiatan_save"); ?>',
			    dataType: 'html',
			    data: { 
			    ...
			    success: function(msg){
			    	...
			    	if (id_belanja == '') {
			    		$.ajax({
							type: "POST",
							url: '<?php echo site_url("rka_perubahan/belanja_keg_lihat_ajax"); ?>',
							dataType: 'html',
							data: {
  ...
  function ubahrowng(id_belanja, tahun){
    ...
    if (check == '' || check == null) {
      ...
      $.ajax({
          type: "POST",
          url: '<?php echo site_url("rka_perubahan/belanja_kegiatan_edit"); ?>',
          dataType: 'json',
          data: {
          id_kegiatan : id_kegiatan,
          id_belanja : id_belanja,
  ...
  function hapusrowng(id_belanja, tahun){
    ...
    $.ajax({
          type: "POST",
          url: '<?php echo site_url("rka_perubahan/belanja_kegiatan_hapus"); ?>',
          dataType: 'json',
          data: {
          id_kegiatan : id_kegiatan,
          id_belanja : id_belanja,
