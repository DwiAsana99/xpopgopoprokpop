...
<script type="text/javascript">
  function select_lihat1(th, from_back, kd_jenis) {
    ...
    $.ajax({
      type: "POST",
      url: '<?php echo site_url("rka/select_belanja_lihat"); ?>',
      dataType: 'JSON',
      data: {
        id_keg: id_kegiatan,
        tahun: th,
...
// var status = true;
		...
		if (status) {
			$.ajax({
			    type: "POST",
			    url: '<?php echo site_url("rka/belanja_kegiatan_save"); ?>',
			    dataType: 'html',
			    data: { 
  ...
  function ubahrowng(id_belanja, tahun){
    ...
    if (check == '' || check == null) {
      ...
      $.ajax({
          type: "POST",
          url: '<?php echo site_url("rka/belanja_kegiatan_edit"); ?>',
          dataType: 'json',
          data: {
  ...
  function hapusrowng(id_belanja, tahun){
    ...
    $.ajax({
          type: "POST",
          url: '<?php echo site_url("rka/belanja_kegiatan_hapus"); ?>',
          dataType: 'json',
          data: {
          id_kegiatan : id_kegiatan,
          id_belanja : id_belanja,
