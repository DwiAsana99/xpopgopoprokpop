...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$('#cetak_all').click(function(){
			// $.blockUI({
			// 	message: 'Cetak dokumen sedang di proses, mohon ditunggu...',
			// 	css: window._css,
			// 	timeout: 2000,
			// 	overlayCSS: window._ovcss
			// });
			var link = '<?php echo site_url("prioritas_pembangunan_rkpd/cetak_all"); ?>';
			// $(location).attr('href',link);
			window.open(link, '_blank');
		});

		$('#cetak_by_kegiatan').click(function(){
			// $.blockUI({
			// 	message: 'Cetak dokumen sedang di proses, mohon ditunggu...',
			// 	css: window._css,
			// 	timeout: 2000,
			// 	overlayCSS: window._ovcss
			// });
			var link = '<?php echo site_url("prioritas_pembangunan_rkpd/cetak_kegiatan_pendukung_prioritas"); ?>';
			// $(location).attr('href',link);
			window.open(link, '_blank');
		});
 		...
 		<table style="border: 0px !important; margin: 0px !important;">
 			<tr>
 				...
 				<td align="right" style="border: 0px !important">
 					<input type="button" class="btn" value="Cetak Per Program / Kegiatan" id="cetak_by_kegiatan">
 					<input type="button" class="btn" value="Cetak Per Perangkat Daerah" id="cetak_all">
 				</td>
 			</tr>
 		</table>
 	</header>
