...
<header>
  ...
  <?php echo "Jendela Kontrol PPAS Perubahan ".$nama_skpd; ?></h3>
</header>
		...
		<tbody>
			...
			<tr align="center">
				<td colspan="3" class="r-ranwal">
					Prioritas dan Plafon Anggaran Pendapatan dan Belanja Daerah Sementara - Perubahan</td>
			</tr>
			<tr>
...
<footer>
    ...
    <?php if (!$rka) {?>
    	<input type="button" class="button-action" id="get_renja" value="Ambil Data Renja Perubahan" />
    <?php }
		else {
	?>
	<?php
	...
	?>
		<input type="button" id="kirim_ppas" value="Kirim PPAS Perubahan" />
	<?php
		}
	?>
    	<a href="<?php echo site_url('ppas_perubahan/preview_ppas'); ?>"><input type="button" value="Lihat PPAS" /></a>
    <?php } ?>
