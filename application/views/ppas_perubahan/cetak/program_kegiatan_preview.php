...
?>
	<tr>
		...
		<th colspan="3">Renja Perubahan Tahun <?php echo $tahun_rka;?></th>
        <th rowspan="2">Indikator Kinerja Program/Kegiatan</th>
...
<?php
	...
	foreach ($program as $row) {
		...
		if ($indikator_program_perubahan->num_rows() > $indikator_program->num_rows()) {
			$total_temp = $indikator_program_perubahan->num_rows();
		}else{	
			$total_temp = $indikator_program->num_rows();
		}
...
<?php
		...
		foreach ($kegiatan as $row) {
			...
			if ($indikator_kegiatan_perubahan->num_rows() > $indikator_kegiatan->num_rows()) {
				$total_temp = $indikator_kegiatan_perubahan->num_rows();
			}else{	
				$total_temp = $indikator_kegiatan->num_rows();
			}
