...
<div style="width: 900px">
	...
	<?php
		if (!empty($program)){
		    echo "Edit Data Program PPAS Perubahan";
		} else{
		    echo "Input Data Program PPAS Perubahan";
		}
	?>
	</h3>
	</header>
	<div class="module_content">
		<form action="<?php echo site_url('ppas_perubahan/save_program_rka');?>" method="POST" name="program" id="program" accept-charset="UTF-8" enctype="multipart/form-data" >
				...
				<tbody>
					...
					<tr>
                      ...
                      <tr>
                        ...
                        <th align="center" width="50%">Plafon Anggaran Perubahan Tahun <?php echo $ta;?></th>
                      </tr>
                      </table>
                      </div>
                      </td>
