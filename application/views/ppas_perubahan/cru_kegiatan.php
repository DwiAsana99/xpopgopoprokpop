...
<div style="width: 1200px">
	...
	<?php
		if (!empty($kegiatan)){
		    echo "Edit Data Kegiatan PPAS Perubahan";
		} else{
		    echo "Input Data Kegiatan PPAS Perubahan";
		}
	?>
	</h3>
	</header>
	<div class="module_content">
		<form action="<?php echo site_url('ppas_perubahan/save_kegiatan');?>" method="POST" name="kegiatan" id="kegiatan" accept-charset="UTF-8" enctype="multipart/form-data" >
			...
			<table class="fcari" width="100%">
				<tbody>
                    ...
                    <tr>
                      ...
                      <tr>
                      	<th align="center" width="50%">Renja Perubahan Tahun <?php echo $ta;?></th>
                        <th align="center" width="50%">Plafon Anggaran Perubahan <?php echo $ta;?></th>
                      </tr>
                      </table>
                      </div>
                      </td>
		            ...
		            <ul class="nav nav-tabs">
		              <li class="active"><a href="#tahun1" data-toggle="tab">Renja Perubahan Tahun <?php echo $ta;?></a></li>
		              <li ><a href="#tahun2" data-toggle="tab">Plafon Anggaran Perubahan <?php echo $ta;?></a></li>
		            </ul>
