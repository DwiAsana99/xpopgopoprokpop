...
<?php
		...
		$bidang = $this->m_usulan_tak_terakomodir->get_bidang_usulan($tahun_usulan,$kode_urusan);
...
<?php
			...
			$program = $this->m_usulan_tak_terakomodir->get_program_usulan($tahun_usulan,$kode_urusan,$kode_bidang);
...
<?php
				...
				$kegiatan = $this->m_usulan_tak_terakomodir->get_kegiatan_usulan($tahun_usulan,$kode_urusan,$kode_bidang,$kode_program);
