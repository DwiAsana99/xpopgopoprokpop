...
<script type="text/javascript">
  function select_lihat1(th, from_back, kd_jenis) {
    ...
    $.ajax({
      type: "POST",
      url: '<?php echo site_url("ppas/select_belanja_lihat"); ?>',
      dataType: 'JSON',
      data: {
        id_keg: id_kegiatan,
        tahun: th,
...
<div style="width: 1200px">
	...
	<div class="module_content">
		<form action="<?php echo site_url('ppas/save_kegiatan');?>" method="POST" name="kegiatan" id="kegiatan" accept-charset="UTF-8" enctype="multipart/form-data" >
			...
			<table class="fcari" width="100%">
				<tbody>
					<?php if (!empty($ket_revisi)): ?>
						<tr style="background-color: #ffc7c7 !important; font-weight: bold;">
							<td width="20%">Keterangan Revisi</td>
							<td width="80%" colspan="2"><?php echo $ket_revisi->keterangan; ?></td>
						</tr>
					<?php endif; ?>
					<tr>
						<td width="20%">SKPD</td>
...
// var status = true;
  ...
  function ubahrowng(id_belanja, tahun){
    ...
    if (check == '' || check == null) {
      ...
      $.ajax({
          type: "POST",
          url: '<?php echo site_url("ppas/belanja_kegiatan_edit"); ?>',
          dataType: 'json',
          data: {
  ...
  function hapusrowng(id_belanja, tahun){
    ...
    $.ajax({
          type: "POST",
          url: '<?php echo site_url("ppas/belanja_kegiatan_hapus"); ?>',
          dataType: 'json',
          data: {
          id_kegiatan : id_kegiatan,
          id_belanja : id_belanja,
