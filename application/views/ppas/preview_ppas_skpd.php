...
<article class="module width_full" style="width: 100%;">
	...
	<table width="99.9%">        
        ...
        <td width="49%">
            Action : <BR>
            <input type="hidden" id="tahun" value="<?php echo $tahun_ppas; ?>"/>
            <input type="button" id="search" class="btn" value="Search"/>
            <input type="button" href="<?= base_url('ppas_preview/do_cetak_ppas_skpd') ?>" id="export" class="btn" value="Cetak"/>
        </td>
	</table>
    </div>
    <table id="tabel_rkpd" class="table-common" width="99.7%">
    	<thead>
            <tr>
...
<script type="text/javascript">
    ...
    $("#search").click(function(){	
        if ($("#id_skpd").val() > 0){
    		...
    		$.ajax({
    			type: "POST",
    			url : "<?php echo site_url('ppas_preview/get_data_ppas_skpd')?>",
    			data: data,
