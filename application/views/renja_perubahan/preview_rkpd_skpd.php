...
<article class="module width_full" style="width: 100%;">
	<header>
	  <h3>Preview RKPD Perubahan Per SKPD</h3>
	</header>
	...
	<table width="99.9%">        
        ...
        <td width="49%">
            ...
            <input type="button" href="<?= base_url('rkpd_preview_perubahan/do_cetak_rkpd_skpd') ?>" id="export" class="btn" value="Cetak"/>
        </td>
	</table>
    </div>
    <table id="tabel_rkpd" class="" width="99.7%">
        ...
        <tbody id="preview_rkpd" >		
             	<tr><td colspan='15' align='center'><strong>Belum ada data terpilih..</strong></td></tr>
         </tbody>
	</table>
    </div>
	<footer>
...
<script type="text/javascript">
    ...
    $("#search").click(function(){	
		...
		$.ajax({
			type: "POST",
			url : "<?php echo site_url('rkpd_preview_perubahan/get_data_rkpd_skpd')?>",
			data: data,
