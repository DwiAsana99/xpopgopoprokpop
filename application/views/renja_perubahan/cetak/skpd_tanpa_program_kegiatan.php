...
<?php
	foreach($skpd_select as $row_select){
		...
		foreach ($skpd as $row_skpd) {
					$tot_nomrenja += $row_skpd->sum_nomrenja;
					$tot_nomrenja_perubahan += $row_skpd->sum_nomrenja_perubahan;
					$tot_nomrenja_skpd=0;
					$tot_nomrenja_perubahan_skpd=0;
			...
			foreach ($urusan as $row_urusan) {
				$tot_nomrenja_skpd+=$row_urusan->sum_nomrenja;
				$tot_nomrenja_perubahan_skpd+=$row_urusan->sum_nomrenja_perubahan;
				echo "
				<tr bgcolor=\"#78cbfd\">
				...
				$bidang = $this->db->query("
					...
					WHERE id_skpd = '".$row_select->id_skpd."'
...
?>
		<tr bgcolor="#FFFF00">
			...
			<td align="right">
            	<strong>
					<?php echo Formatting::currency($tot_nomrenja_skpd,2) ;?>
                <strong>
            </td>
			<td align="right">
            	<strong>
					<?php echo Formatting::currency($tot_nomrenja_perubahan_skpd,2); ?>
                </strong>
            </td>
		</tr>
<?php
...
?>
		<tr bgcolor="#999999">
			...
			<td align="right">
            	<strong>
					<?php echo Formatting::currency($tot_nomrenja,2) ;?>
                <strong>
            </td>
			<td align="right">
            	<strong>
					<?php echo Formatting::currency($tot_nomrenja_perubahan,2); ?>
                </strong>
            </td>
		</tr>
</tbody>
