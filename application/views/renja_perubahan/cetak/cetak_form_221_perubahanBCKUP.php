...
<table width="100%"  style=" font-family:'Droid Sans', Helvetica, Arial, sans-serif;" >
  <tbody>
    ...
    <tr>
      <td colspan="13">
        <!-- Kelompok Sasaran Kegiatan : Empat sambungan telepon, internet dan 6 jenis media cetak -->
      </td>
    </tr>
  </tbody>
</table>
...
<table  width="100%"  style=" font-family:'Droid Sans', Helvetica, Arial, sans-serif;" style="margin-top:0px;">
  ...
  <tbody>
       <tr>
      <td rowspan="3" align="center"><strong>KODE<br> REKENING</strong></td>
     ...
     <?php
                ...
                foreach ($tahun1 as $rowth1  ) { 
                    ...
                    if ($rowth1->kode_jenis_belanja == $jenis) {
                        ...
                        $selisihNominalDetilPersen =  ($rowth1->subtotal>0)?($selisihNominalDetil/$rowth1->subtotal)*100:'0';
                       ...
                       for ($i = 0; $i < $jumlah; $i++) {
                        $TotalBelanja += $tahun1[$i]->subtotal;
                         ...
                         $selisihbelanja = $TotalBelanja-$TotalBelanjaPerubahan;
                          $selisihbelanjaPersen =  ($TotalBelanja>0)?($selisihbelanja/$TotalBelanja)*100:'0';
                         if ( $selisihbelanja>0) {
                       ...
                       for ($i = 0; $i < $jumlahKT; $i++) {
                        if ($kategori == $tahun1[$i]->kode_kategori_belanja){
                            ...
                            $selisihketegoribelanjaPersen =  ($TotalKategoriBelanja>0)?($selisihketegoribelanja/$TotalKategoriBelanja)*100:'0';
                       ...
                       for ($i = 0; $i < $jumlahSKT; $i++) {
                        if ($subkategori == $tahun1[$i]->kode_sub_kategori_belanja){
                            ...
                            $selisihsubketegoribelanjaPersen =  ($TotalSubKategoriBelanja>0)?($selisihsubketegoribelanja/$TotalSubKategoriBelanja)*100:'0';
                       ...
                       for ($i = 0; $i < $jumlahBel; $i++) {
                        if ($kdbelanja == $tahun1[$i]->kode_belanja){
                            ...
                            $selisihbelanja1Persen =  ($TotalBelanja1>0)?($selisihbelanja1/$TotalBelanja1)*100:'0';
