<?php
 ...
 if ($namafile != '') {
	...
	echo '<div align="center" style="font-weight: bold; font-size: 20px; text-transform: uppercase;">Tabel Indikasi Program Prioritas</div>';
 }else{
	echo '<div align="center" style="font-weight: bold; font-size: 16px; text-transform: uppercase;">Tabel Indikasi Program Prioritas</div>';
 }

?>
<!-- <div align="center" style="font-weight: bold; font-size: 20px; text-transform: uppercase;">Tabel Indikasi Program Prioritas</div> -->
