...
<tbody>
	<?php
		foreach ($musrenbangkab1 as $row) {
			$total = 0;
			$id_keputusan = 1;
			$musrenbangkab_detail = $this->m_musrenbang->get_data_musrenbangcam_detail($row->kode_kegiatan,$row->id_skpd,$id_keputusan);
	...
	?>
			<tr >
				...
				<?php
					foreach ($musrenbangkab_detail as $row) {
				?>
					<tr >
