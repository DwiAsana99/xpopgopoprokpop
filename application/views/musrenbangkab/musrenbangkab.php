<script type="text/javascript">
	...
	function showDaftarUsulanMusrenbang ( d ) {
	    ...
	    $.ajax({
		 	type: "POST",
		 	url: "<?php echo $url_data_list_musrenbangkab?>",
	...
	$(document).ready(function(){
		...
		$('#musrenbangkab tbody').on('click', 'td.details-control', function () {
	...
	function terima_usulan_musrenbangkab(id_musrenbang){
		if (confirm('Apakah anda yakin untuk menyetujui data musrenbangkab ini?')) {
			$.blockUI({
	...
	function tolak_usulan_musrenbangkab(id_musrenbang){
		//load fancy box
    prepare_facebox();
    $.blockUI({
			css: window._css,
	...
	function valid_usulan_musrenbangkab(id_musrenbang){
		if (confirm('Apakah anda yakin untuk menyetujui data musrenbangkab ini?')) {
			$.blockUI({
				message: 'Proses perubahan status sedang dilakukan, mohon ditunggu ...',
				css: window._css,
...
<article class="module width_full">
	<header>
	  <h3>Tabel Data Musrenbangkab</h3>
	</header>
	<div class="module_content"; style="overflow:auto">
    <div style='float:right'>
    <a href="<?php echo site_url('musrenbangkab/do_cetak_musrenbangkab') ?>"><input style="margin: 3px 10px 0px 0px; float: right;" type="button" value="Cetak Musrenbangkab" /></a>
    <a href="<?php echo site_url('musrenbangkab/preview_musrenbangkab') ?>"><input style="margin: 3px 10px 0px 0px; float: right;" type="button" value="Lihat Musrenbangkab" /></a>
    <a href="<?php echo $url_add_data ?>"><input style="margin: 3px 10px 0 10px; float: right;" type="button" value="Tambah Data Musrenbangkab" /></a>
    </div><br>
		<table id="musrenbangkab" class="table-common tablesorter" style="width:100%">
			<thead>
				<tr>
					<th style="width:5%"></th>
