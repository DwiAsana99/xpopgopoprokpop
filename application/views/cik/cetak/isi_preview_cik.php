...
<?php
	...
	foreach($urusan as $row_urusan){
		...
		foreach ($bidang as $row_bidang) {
			...
			$program = $this->m_cik->get_program_cik_4_cetak($id_skpd,$bulan,$tahun,$row_urusan->kd_urusan,$row_bidang->kd_bidang);
	...
	if($row->id == ""){
		...
		$result = $this->m_cik->get_kegiatan_cik_4_preview($row_urusan->kd_urusan,$row_bidang->kd_bidang,$row->kd_program,$id_skpd,$bulan,$tahun);
